 ...
 * (see session-scratch.mjs) — stored per-session to prevent concurrent sessions
 * of the same project from polluting each other's edit tracking. Never blocks: any failure exits 0.
 */
